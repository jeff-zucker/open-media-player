...
import { star } from '../shared/omp-favourites-ui.js';
import { listFavourites, removeFavouriteFile } from '../shared/omp-favourites-store.js';
...
class OmpImages extends HTMLElement {
  ...
  async _favourite(coll) {
    ...
    } catch (err) { console.warn('[favourite]', err.message); }
  }
