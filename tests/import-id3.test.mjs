// The ID3 import RDF builder (src/ia-player/import-id3-build.js): the docs
...
import { groupReleases, buildLibraryDocs, slugify, fileUrl } from '../src/ia-player/import-id3-build.js';

const root = join(dirname(fileURLToPath(import.meta.url)), '..');
const MUSIC_SHAPE = join(root, 'shapes/music.shacl');
